  ...
  useEffect(() => {
    ...
    const syncObjects = () => {
      ...
      for (const o of Object.keys(threeObjStore)) {
        if (!varMap.some((v) => v.name == o)) {
          //if our obj store contains THREE objects no longer referenced in code,
    ...
    const listener = (e) => {
      ...
      // Only execute code generation and update threeObjStore without triggering rendering.
      generateAndRun(ws)
    }
